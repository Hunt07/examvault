...
interface AppContextType {
  ...
  deactivateAccount: () => Promise<void>; // Added deactivation
...
const App: React.FC = () => {
  ...
  // Global Filtering: Only show content from active users
  ...
  const deleteAccount = async () => {
    ...
    try {
        ...
        // PERMANENT PURGE: Find and delete all user-owned content
        ...
        setUser(null); 
        setViewState('dashboard');
        showToast("Account and all content purged permanently.", "info");
    } catch (error) {

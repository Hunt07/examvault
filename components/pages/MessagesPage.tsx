                            ...
                            >
                                ...
                                <div className="absolute right-2 top-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button 
                                        ...
                                        className="p-1.5 rounded-full bg-white dark:bg-zinc-700 text-slate-400 hover:text-red-600 dark:text-slate-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-zinc-600 shadow-sm border border-slate-200 dark:border-zinc-600 transition-colors"
